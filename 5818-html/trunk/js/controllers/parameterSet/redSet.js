 ...
 */
angular.module("admin").controller('redSetController',['$scope','parameterService','$state','$rootScope', function ($scope, parameterService, $state, $rootScope) {
    var vm = this;
    ...
    //获取红包列表
    function getRedSet() {
        parameterService.getRedSet(vm.searchParams).then(function (res) {
