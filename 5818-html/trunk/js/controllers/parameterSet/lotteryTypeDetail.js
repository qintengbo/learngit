 ...
 */
angular.module("admin").controller('lotteryTypeDetailController',['$scope','FileUploader','$state','$rootScope','uploadService','parameterService','$timeout',function($scope,FileUploader,$state,$rootScope,uploadService,parameterService,$timeout){
    var vm =this;
