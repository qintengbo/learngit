...
angular.module('admin')
    .controller('ModuleCtrl',['$state','$scope','$rootScope','$cookies','commonUtil','moduleService','roleService', function($state,$scope, $rootScope,$cookies,commonUtil,moduleService,roleService) {
        var vm = $scope.vm = {};
