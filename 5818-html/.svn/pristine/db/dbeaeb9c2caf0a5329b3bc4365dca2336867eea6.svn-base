...
angular.module('admin')
    .controller('RoleDetailCtrl',['$state','$scope','$rootScope','commonUtil','roleService','managerService','moduleService', function ($state, $scope, $rootScope, commonUtil, roleService, managerService, moduleService) {
        var vm = $scope.vm = {};
