 ...
 */
'use strict'
angular.module('admin').controller('versionControllerDetailCtrl',['$scope','uploadService','FileUploader','parameterService','$state','$rootScope',function ($scope,uploadService,FileUploader,parameterService,$state,$rootScope){
    var vm =this;
    vm.params={};
    vm.params.type=8;
    ...
    $scope.submit=function(){
        $rootScope.confirm('是否确认更新版本',function(){
            vm.params.content=vm.um.getContentTxt();
