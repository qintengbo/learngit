 ...
 */
angular.module("admin").controller('adviertisementDetailController',['$rootScope','$scope','$state','parameterService','$timeout',function($rootScope,$scope,$state,parameterService,$timeout){
    var vm = this;
