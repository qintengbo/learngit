 ...
 */
angular.module("admin").controller("bannerDetailController", function ($scope, $state, parameterService,$rootScope, uploadService, FileUploader,$timeout) {
    var vm = this;
    //banner type为2
    vm.params = {};
    vm.params.type = 2;
